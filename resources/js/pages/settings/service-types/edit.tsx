...
export default function EditServiceTypePage({ serviceType }: EditServiceTypePageProps) {
  const { data, setData, patch, processing, errors } = useForm({
    name: serviceType.name,
    slug: serviceType.slug,
    description: serviceType.description || '',
    inc_type: serviceType.inc_type,
    amount: serviceType.amount,
  })

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/settings/service-types/${serviceType.id}`)
  }
    ...
    <AppLayout>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Service Type</h1>
            <p className="text-gray-600 mt-1">Update work type and pricing increment</p>
          </div>
        </div>
        ...
        <Card className="max-w-2xl">
          <CardHeader>
            ...
            <CardDescription>
              Update the work type and its pricing increment
            </CardDescription>
          </CardHeader>
          <CardContent>
